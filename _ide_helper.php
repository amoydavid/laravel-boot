...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Response::ok($data, $message);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function fail($message = 'error', $code = 500, $data = [])
        {
                        return \Illuminate\Http\Response::fail($message, $code, $data);
        }
